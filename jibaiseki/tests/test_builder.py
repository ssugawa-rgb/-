...
def test_build_rows():
    records = [
        {"証券番号": "61LGV2895", "件数": 1, "保険料": 24190, "令和年": 8, "月": 7, "日": 16, "拠点コード": "038"},
        {"証券番号": "61LH26375", "件数": 1, "保険料": 18160, "令和年": 8, "月": 7, "日": 17, "拠点コード": "049"},
    ]
...
def test_unknown_code_leaves_blank():
    records = [{"証券番号": "61ZZ00000", "件数": 1, "保険料": 17650, "令和年": 8, "月": 7, "日": 20, "拠点コード": "999"}]
    conf = {"company_name": "損保ジャパン", "fee_per_unit": 1735}
